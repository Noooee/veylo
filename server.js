...
//
// 重要:
// 初回起動時にユーザーが1人もいない状態で
// owner_id = 1 を入れると外部キーエラーになるため、
// 最初のユーザー登録後に作成する。
// ==================================================

function ensureCasualRoom(
  ownerId
) {
